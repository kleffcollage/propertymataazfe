      ...
      <div className="col-lg-3">
        <div className="listing-cards">
          <div className="listing-cover-img">
            <img src={property.mediaFiles.length > 0 ? property.mediaFiles[0].url : ""} />
            <div className="listing-location">{property.area}</div>
          </div>
          <div className={`tag ${property.isDraft == true ? "draft" : property.verified == true ?  "verified" : "pending"}`}>
            <div className="status">
              {property.isDraft == true ? "Only visible to you" : property.verified == true ?  "Listing hace been verified" : "Listing is pending"}
            </div>
            <div className="status">
