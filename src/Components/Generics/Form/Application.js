      ...
      {page == 1 ? (
        <div className="modal-content">
          <div className="content-section mt-4">
            ...
            {clean ? (
              <>
                ...
                <div className="d-flex justify-content-between mb-4 typeof-building">
                  <div
                    className={`tab ${
                      type == BuildingType.RESIDENTIAL ? "active" : ""
                    }`}
                    onClick={() => selectType(BuildingType.RESIDENTIAL)}
                  >
                    {" "}
                    Residential{" "}
                  </div>
                  <div
                    className={`tab ${
                      type == BuildingType.COMMERCIAL ? "active" : ""
                    }`}
                    onClick={() => selectType(BuildingType.COMMERCIAL)}
                  >
                    {" "}
                    Commercial{" "}
                  </div>
                  ...
                  <div className="select-box">
                    ...
                    >
                      ...
                      {buildingType.map((_building, index) => {
                        return (
                          <option key={index} value={_building.id}>
                            {_building.name}
                          </option>
                        );
                      })}
                ...
                <div className="input-box">
                  ...
                  <DatePicker
                    selected={dateForClean}
                    onChange={(date) => setDateForClean(date)}
                    className="formfield"
                  />
                  ...
                  <div className="select-box">
                    ...
                    >
                      ...
                      {states.map((_state, index) => {
                        return (
                          <option key={index} value={_state.name}>
                            {_state.name}
                          </option>
                        );
                      })}
            ...
            <button tyoe='button' className="options my-1" onClick={close}>
              Cancel
            </button>
            {clean && (
              <div className="d-flex flex-column items-center justify-content-center text-center term-condition mb-4">
                ...
                <Link to="/" className="term-condition font-weight-bold">
                  Terms & Conditions
                </Link>
              </div>
            )}
